...
<tr align=right>
<td>
<Button type=buttn onClick=window.location.href='/board/remove/${list.no}'>삭제</Button>
<Button type=buttn onClick=window.location.href='/board/updateCon/${list.no}'>수정</Button>
<Button type=buttn onClick=window.location.href='/board'>목록</Button>
...
<!-- 댓글 페이지 -->
	...
	<!--댓글목록-->
	function getAllList(){
	$.getJSON("/board/replies/all/"+ no, function(data){
		var str="";
	...
	function getPageList(page){
		$.getJSON("/board/replies/"+no+"/"+page , function(data){
